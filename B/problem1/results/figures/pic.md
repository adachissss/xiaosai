...
- `B/problem1/scripts/solve_problem1.py`：运行 S0/S1/S2/S3 四组方案，并生成基础对比图。
- `B/problem1/scripts/plot_problem1.py`：读取已生成的结果 CSV，生成更适合论文展示的分析图。

---

## 1. `grid_import_comparison.png`

- **来源脚本**：`B/problem1/scripts/solve_problem1.py`
- **含义**：四组方案的外网购电功率对比。
...
- **来源脚本**：`B/problem1/scripts/plot_problem1.py`
- **含义**：四组方案外网购电功率对比图。
